...
export default function RecordingButton({ variant = 'icon', autoStart = false }: RecordingButtonProps) {
  ...
  const startRecording = async () => {
    if (autoStart) {
      ...
      // Navigate to recording page WITHOUT autoStart flag
    ...
    return (
      <div className="flex items-center gap-3">
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 rounded-lg text-white font-medium transition-all duration-200 shadow-lg hover:shadow-xl bg-teal-600 hover:bg-teal-700"
        >
