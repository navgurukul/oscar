...
const GITHUB_RELEASE_BASE = "https://github.com/navgurukul/oscar/releases/download/v0.2.10";

const DOWNLOAD_URLS: Record<Exclude<Platform, null>, string> = {
  "mac-intel": `${GITHUB_RELEASE_BASE}/OSCAR_0.2.10_x64.dmg`,
  "mac-silicon": `${GITHUB_RELEASE_BASE}/OSCAR_0.2.10_aarch64.dmg`,
  windows: `${GITHUB_RELEASE_BASE}/OSCAR_0.2.10_x64-setup.exe`,
  linux: `${GITHUB_RELEASE_BASE}/OSCAR_0.2.10_amd64.AppImage`,
};
